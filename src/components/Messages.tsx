  ...
  return (
    ...
    >
      ...
      {messages.map((message, index) => {
        ...
        return (
          <section key={`${message.id}-${message.timestamp}`}>
            {dateHeader}
            <div
            ...
            >
              ...
              >
                ...
                >
                  <span
                    className={cn(
                      'px-4 py-2 rounded-lg inline-block shadow-sm',
                      {
                  ...
                  <span
                    className={cn('text-xs text-gray-500 px-1', {
                ...
                <div
                  className={cn(
                    'relative w-8 h-8 rounded-full overflow-hidden ring-2 ring-white',
                    {
