        ...
        <div className="flex h-16 shrink-0 items-center justify-between px-6 border-b border-gray-100">
          <Link href="/dashboard" className="flex items-center gap-2">
            {Icons.Logo ? (
              ...
              <span className="h-8 w-8 flex items-center justify-center bg-blue-600 text-white rounded-md font-bold text-lg">SC</span>
            )}
            <span className="font-semibold text-lg text-gray-800">SecureCosmetic</span>
          </Link>
          <NotificationBell />
        </div>
          ...
          {jobs?.length > 0 && (
            <div className="px-4 py-4 border-b border-gray-100">
              <div className="flex items-center justify-between mb-2">
                <h2 className="text-sm font-medium text-gray-900">Your chats</h2>
                    ...
                    <li key={option.id}>
                      ...
                      >
                        <span className={cn(
                          ...
                          option.href === "/dashboard/requests" && unseenJobCount > 0 && "bg-blue-50 text-blue-600 border-blue-200"
                        )}>
                          {getIcon(option.Icon)}
                        </span>
                        ...
                        {/* Request badge */}
                        {option.href === "/dashboard/requests" && unseenJobCount > 0 && (
